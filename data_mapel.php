...
<main class="min-h-[100vh] w-full flex flex-col items-center justify-center" style="background-image: url(img/circleholo.jpg); background-repeat: no-repeat; background-size: cover;">
        ...
        <h1 class="text-white text-[35px] text-center mt-20 mb-5">TOTAL DATA MAPEL</h1>
        <div class="mb-10">
            <div class="btns flex gap-[15px]">
                <div class="btn-tambah">
                    <a href="input_mapel.php" type="submit" class="text-white px-4 py-1 bg-white/10 border-[1px] border-slate-50 rounded-lg hover:bg-transparent hover:backdrop-blur-xl">Tambah Data</a>
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex gap-2">
                                <a href="ubah_mapel.php?data=<?=$result['id_mapel']?>"class="border-[1px] rounded-md bg-white/10 hover:bg-green-600/90"><img src="img/pen.svg" alt="" width="40"></a>
                                <a href="hapus_mapel.php?data=<?=$result['id_mapel']?>" onclick="return confirm('Apakah yakin ingin menghapus ?');"class="border-[1px] rounded-md bg-white/10 hover:bg-red-600/90"><img src="img/trash.svg" alt="" width="40"></a>
                            </div>
                        </td>
                    </tr>
                    <?php
